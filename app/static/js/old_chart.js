...
function plotVolume2(data, svglowContainer, coords) {
...
function makePlot(stock){
  ...
  drawBox(svgContainer, width, height)
     ...
     var margin = {top: 30, right: 8, bottom: 30, left: 50},
  ...
  drawBox(svglowContainer2, width, height)
    ...
    .done(function( data ) {
      ...
      if (data == "error"){
        ...
        plotVolume2(data, svglowContainer2, coords['volumechart'])
      }
    })
